...
def tests_to_run(forwarder):
    from tests import BasicTest, RandomDropTest, SackRandomDropTest, RandomDuplicateTest, RandomLoseSeqTest, SackRandomDuplicateTest, SackRandomLoseSeqTest
    ...
    RandomLoseSeqTest.RandomLoseSeqTest(forwarder, "README")
    SackRandomDropTest.SackRandomDropTest(forwarder, "README")
    SackRandomDuplicateTest.SackRandomDuplicateTest(forwarder, "README")
    SackRandomLoseSeqTest.SackRandomLoseSeqTest(forwarder, "README")
"""
